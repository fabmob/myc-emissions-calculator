                        ...
                        <Table bordered>
                            <thead>
                                <tr>
                                    ...
                                    <th className="item-sm"><ItemWithOverlay overlayContent="Reminder of load values used during inventory"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Inv. load</ItemWithOverlay></th>
