                ...
                >
                    {project.referenceYears && project.referenceYears.slice(1).map((y, yearIndex) => (<Tab eventKey={y} title={y} key={yearIndex}>
                        ...
                        <Table bordered>
                            <thead>
                                <tr>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Users shifted to this transport mode, generating additional passenger.kilometers"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Goal vehicle</ItemWithOverlay></th>
                                    ...
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Passenger.kilometers at the end of previous year"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Pkm {project.referenceYears[yearIndex]} (Mkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Passenger.kilometers at the end of this year"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Pkm {y} (Mkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Additional passenger.kilometers generated by user shift. This can be due to additional vkt or a change in vehicle occupancy"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Added Pkm to distribute (Mpkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Users shifted from this transprt mode"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Origin vehicle</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Reminder of trip length set in inventory, this value is used to convert passager.kilometers to trips"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Inventory trip len (km)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Source of trip share, click the blue + button to add a source"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Src</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Coefficient of trips that shifted from origin vehicle to goal vehicle. The sum should be 100% per goal vehicle, but the tool deduces missing values."><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Part of trips to shift (%)</ItemWithOverlay></th>
                        ...
                        <Table bordered>
                            <thead>
                                <tr>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Users shifted to this transport mode, generating additional tons.kilometers"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Goal vehicle</ItemWithOverlay></th>
                                    {/* <th className="item-sm" style={{whiteSpace: "initial"}}><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {project.referenceYears[yearIndex]} (Mkm)</th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {y} (Mkm)</th> */}
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Tons.kilometers at the end of previous year"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Tkm {project.referenceYears[yearIndex]} (Mkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Tons.kilometers at the end of this year"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Tkm {y} (Mkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Additional Tons.kilometers generated by user shift. This can be due to additional vkt or a change in vehicle load"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Added Tkm to distribute (Mtkm)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Users shifted from this transprt mode"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Origin vehicle</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Source of tkm share, click the blue + button to add a source"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Src</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent="Percent of tkm that shifted from origin vehicle to goal vehicle. The sum should be 100% per goal vehicle, but the tool deduces missing values."><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Part of tkm to shift (%)</ItemWithOverlay></th>
                                    <th className="item-sm" style={{whiteSpace: "initial"}}><ItemWithOverlay overlayContent={
                                        <div>
                                    ...
                                    }><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> tkm shifted to goal</ItemWithOverlay></th>
                                </tr>
                            </thead>
                            <tbody>
                                {Object.keys(inputData.vtypes).filter(vtype => isVtypeFreight(vtype)).map((goalvtype) => {
