                ...
                >
                    {project.referenceYears && project.referenceYears.slice(1).map((y, yearIndex) => (<Tab eventKey={y} title={y} key={yearIndex}><hr></hr>
                        ...
                        <Table bordered>
                            ...
                            <thead>
                                <tr>
                                    <th><ItemWithOverlay overlayContent="Users shifted to this transport mode, generating additional passenger.kilometers"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Target vehicle</span></span></ItemWithOverlay></th>
                                    {/* <th><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {project.referenceYears[yearIndex]} (Mkm)</th>
                                    <th><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {y} (Mkm)</th> */}
                                    <th><ItemWithOverlay overlayContent="Passenger.kilometers at the end of previous year"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>{project.referenceYears[yearIndex]} Pkm (Mkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Passenger.kilometers at the end of this year"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>{y} Pkm (Mkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Additional passenger.kilometers generated by user shift. This can be due to additional vkt or a change in vehicle occupancy"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Added Pkm to distribute (Mpkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Users shifted from this transprt mode"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Origin vehicle</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Reminder of trip length set in inventory, this value is used to convert passager.kilometers to trips"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Inv. trip length (km)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Source of trip share, click the blue + button to add a source"><span className="item"><span>Src</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Coefficient of trips that shifted from origin vehicle to goal vehicle. The sum should be 100% per goal vehicle, but the tool deduces missing values."><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Part of trips to shift (%)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent={
                                        <div>
                                            ...
                                            <div style={{backgroundColor: "#C5E8F2", padding: "10px", margin: "10px 0px 10px 0px"}}>
                                                <Badge className="badge-read-only"><span className="item"><span>Added Pkm to distribute (Mpkm)</span></span></Badge> × <Badge className="badge-read-only"><span className="item"><span>Part of trips to shift (%)</span></span></Badge> × <Badge className="badge-read-only"><span className="item"><span>Inv. trip length</span></span></Badge> / SUM(<Badge className="badge-read-only"><span className="item"><span>Inv. trips lengths (km)</span></span></Badge> × <Badge className="badge-read-only"><span className="item"><span>Parts of trips to shift (%)</span></span></Badge>)
                                            </div>
                                    ...
                                    return Object.keys(goalvehicle).filter(vtype => vtype !== goalvtype && !isVtypeFreight(vtype)).map((originvtype, index) => {
                                        ...
                                        return (
                                            <tr key={goalvtype + originvtype}>
                                                {index === 0 && <td style={{verticalAlign: "top"}} rowSpan={Object.keys(inputData.vtypes).filter(vtype => !isVtypeFreight(vtype)).length}><Badge className="badge-read-only"><span className="item"><span>{goalvtype}</span></span></Badge></td>}
                                                ...
                                                <td>{originvtype === "Induced Traffic" 
                                                    ? <ItemWithOverlay overlayContent="Part of additional trips that were induced. These trips are new, not shifted from another transport type."><Badge className="badge-read-only"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Induced traffic</span></span></Badge></ItemWithOverlay>
                                                    : <Badge className="badge-read-only"><span className="item"><span>{originvtype}</span></span></Badge>
                                                }</td>
                        ...
                        <Table bordered>
                            ...
                            <thead>
                                <tr>
                                    <th><ItemWithOverlay overlayContent="Users shifted to this transport mode, generating additional tons.kilometers"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Target vehicle</span></span></ItemWithOverlay></th>
                                    {/* <th><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {project.referenceYears[yearIndex]} (Mkm)</th>
                                    <th><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg> Vkt {y} (Mkm)</th> */}
                                    <th><ItemWithOverlay overlayContent="Tons.kilometers at the end of previous year"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>{project.referenceYears[yearIndex]} Tkm (Mkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Tons.kilometers at the end of this year"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>{y} Tkm (Mkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Additional Tons.kilometers generated by user shift. This can be due to additional vkt or a change in vehicle load"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Added Tkm to distribute (Mtkm)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Users shifted from this transprt mode"><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Origin vehicle</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Source of tkm share, click the blue + button to add a source"><span className="item"><span>Src</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent="Percent of tkm that shifted from origin vehicle to goal vehicle. The sum should be 100% per goal vehicle, but the tool deduces missing values."><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#circle-info"}/></svg><span>Part of tkm to shift (%)</span></span></ItemWithOverlay></th>
                                    <th><ItemWithOverlay overlayContent={
                                        <div>
                                            Computed tkm shifted from origin vehicle to goal vehicle
                                            <div style={{backgroundColor: "#C5E8F2", padding: "10px", margin: "10px 0px 10px 0px"}}>
                                                <Badge className="badge-read-only"><span className="item"><span>Added Tkm to distribute (Mtkm)</span></span></Badge> × <Badge className="badge-read-only"><span className="item"><span>Part of tkm to shift (%)</span></span></Badge> / <Badge className="badge-read-only"><span className="item"><span>SUM of parts of tkm to shift for goal vehicle (%)</span></span></Badge>
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                {Object.keys(inputData.vtypes).filter(vtype => isVtypeFreight(vtype)).map((goalvtype) => {
                                    ...
                                    return Object.keys(inputData.vtypes).filter(vtype => vtype !== goalvtype && isVtypeFreight(vtype)).map((originvtype, index) => {
                                        ...
                                        return (
                                            <tr key={goalvtype + originvtype}>
                                                {index === 0 && <td style={{verticalAlign: "top"}} rowSpan={Object.keys(inputData.vtypes).filter(vtype => isVtypeFreight(vtype)).length -1}><Badge className="badge-read-only"><span className="item"><span>{goalvtype}</span></span></Badge></td>}
                                                ...
                                                <td><Badge className="badge-read-only"><span className="item"><span>{originvtype}</span></span></Badge></td>
                                                {computedASI && computedASI.pkmsAdded?.[yearIndex+1]?.[goalvtype] > 0 
                                                    ? <td>{source
                                                        ? <ValidSource source={source} onClick={(e:any) => configureSource(goalvtype, originvtype)}/>
                                                        : <Button size="sm" variant="action" onClick={e => configureSource(goalvtype, originvtype)}><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#plus"}/></svg></span></Button>}</td>
