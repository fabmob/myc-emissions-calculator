            ...
            <section>
                <Container className="projectStepContainer">
                    <Row className="justify-content-md-center">
                        ...
                        <Col lg="8" className="stepRight">
                            {props.children}
                            {props.setInputData && (props.noteValue === undefined 
                                ? <Button className="user-note-button" variant="link" onClick={e=>setNote("")}>
                                    <ItemWithOverlay overlayContent="Write a note to keep track of hypothesis and assumptions used to fill this step. For exemple, what arithmetic operations were used to convert data from sources to this tool's expected format."><span className="item"><svg className="icon icon-size-s" viewBox="0 0 22 22"><use href={"/icons.svg#plus"}/></svg><span>Add a note</span></span>
                                    </ItemWithOverlay>
                                </Button>
